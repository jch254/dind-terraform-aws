...
This image is based on docker:dind (Alpine-based) and has Terraform 0.11.14 and the AWS CLI installed (see [Dockerfile](./Dockerfile) for all other installed utilities).
